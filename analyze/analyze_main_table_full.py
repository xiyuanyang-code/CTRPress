...
# 配置
RESULTS_DIR = "/data/xiyuanyang/EfficientNLP/full"
OUTPUT_DIR = "/data/xiyuanyang/EfficientNLP/analyze/full_tables"
MODEL = "pythia"
COMPRESSION_RATIOS = [0.3, 0.5, 0.7]
METHODS = [
    "no_compress", "random", "streaming_llm", "snapkv", "pyramidkv",
    "lagkv", "keydiff", "query_aware",
    "ctr", "ctr_refine", "ctr_semantic",
